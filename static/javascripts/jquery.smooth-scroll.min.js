...
function ssc_pulse_(a){var b;a*=ssc_pulseScale;1>a?b=a-(1-Math.exp(-a)):(b=Math.exp(-1),--a,a=1-Math.exp(-a),b+=a*(1-b));return b*ssc_pulseNormalize}function ssc_pulse(a){if(1<=a)return 1;if(0>=a)return 0;1==ssc_pulseNormalize&&(ssc_pulseNormalize/=ssc_pulse_(1));return ssc_pulse_(a)}
